...
//    dólares, considerando ainda que a pessoa terá que pagar 6% de IOF sobre o valor em dólar.
//    Criar uma classe CurrencyConverter para ser responsável pelos cálculos.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Amount to be paid in reais = " + String.format(
                "%.2f", CurrencyConverter.converter(dollarPrice, dollarQuantity)
        ));
    }
}
